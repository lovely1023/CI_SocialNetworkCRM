...
//$response = $client->Messages->GetMessagesDetails();
    ...
    //$response = $client->Account->GetBalance();
    // $message = 'This is your OTP: '.$_POST['otp'];
	// $response = $client->Messages->Send('966596623370',$message,'AADMAS'); // send regular massage
	// $response = $client->Messages->GetScheduled();
    // echo $response.' '.$_POST['otp'].' '.$_POST['phone_number'];
// } catch (Exception $e) {
    // echo $e->getCode();
// }
// ?>
